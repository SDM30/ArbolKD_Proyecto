...
int main() {
    ...
    arbol.insertar(Vertice(0, 50, 50, 50));  // Punto adicional
    arbol.insertar(Vertice(0, 0, 0, 0));     // Punto cerca del origen
    arbol.insertar(Vertice(0, 100, 100, 100)); // Punto muy alejado
